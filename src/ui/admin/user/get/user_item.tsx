import { MagnifyingGlassCircleIcon, TrashIcon } from '@heroicons/react/24/outline';
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { User } from '../../../../model/user_model';
import * as UserService from '../../../../services/user/user';

export const UserItemComponent: React.FC<{ index: number; user: User }> = (props: {
  index: number;
  user: User;
}) => {
  ...
  const closeAdminShow = () => setAdminShow(false);
  ...
  return (
    <tr className="bg-white hover:bg-gray-50">
      ...
      <td className="py-4 px-6 font-medium text-gray-900 ">{props.user.role}</td>
              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-6 text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    ...
                    {props.user.role === 'user' ? 'user to admin' : 'admin to user'}?
                  </h3>
                  <button
                    ...
                    onClick={async () => {
                      if (props.user.id) {
                        let res = await UserService.updateRole(props.user.id);
                        if (res === true) {
                          navigate(0);
                        } else {
                          closeAdminShow();

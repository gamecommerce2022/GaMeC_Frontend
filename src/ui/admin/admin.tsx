        ...
        <div className="flex flex-row h-fit bg-[#f9fafb]">
            ...
            <div className="flex-1 m-4 lg:m-10 sm:m-6 shawdow drop-shadow-md p-4 rounded-xl bg-white h-[900px]">
                <Routes>
                    ...
                    <Route key="admin-product-add-page" path="products/add" element={<ProductAddComponent />} />
                    <Route key="admin-product-edit-page" path="products/:productId" element={<ProductEditComponent />} />

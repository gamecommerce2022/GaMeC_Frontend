...
export const ProductItem: React.FC<{ index: number, product: Product }> = (props: { index: number, product: Product }) => {
  ...
  <div className="flex flex-row h-full items-center justify-around">
        <PencilIcon className="w-4 h-4 text-blue-500 hover:text-orange-500 dark:text-white dark:hover:text-orange-500" onClick={() => { }} />
        <TrashIcon className="w-4 h-4 text-blue-500 hover:text-orange-500 dark:text-white dark:hover:text-orange-500" onClick={() => { }} />
      </div>
  </td>
</tr>  
}
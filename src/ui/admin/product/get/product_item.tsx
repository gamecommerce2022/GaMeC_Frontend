    ...
    <tr className="bg-white hover:bg-gray-50">
      ...
      <td className="py-4 px-6">
        <div className="flex flex-row h-full items-center justify-around">
          ...
          <div id="popup-modal" className={`${show ? 'overflow-y-auto overflow-x-hidden fixed  z-50 md:inset-0 h-modal md:h-full bg-gray-500/50 rounded' : 'hidden'} `}>
            <div className="relative p-4 w-full max-w-md h-full md:h-auto m-auto top-1/4 opacity-100">
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" onClick={closeShow}>
                ...
                <div className="p-6 text-center">
                  ...
                  <button data-modal-toggle="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" onClick={async () => {

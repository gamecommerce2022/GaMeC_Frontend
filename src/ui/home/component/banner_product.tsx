...
const BannerProduct: React.FC<BannerProductProp> = (props) => {
 ...
 return (
  <div key={bannerProduct.id} className="relative overflow-hidden bg-gray-900 pointer-events-none h-full" style={{ backgroundImage: `url('https://source.unsplash.com/random/1920x1080/?black')` }}>
    ...
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
     ...
     <div>
      <div className="mt-10">
       ...
       <Link
        to={bannerProduct.link}
        className="inline-block rounded-md border border-transparent bg-amber-500 py-3 px-8 text-center font-bold text-xl text-gray-200 hover:bg-amber-700"
       >
        {bannerProduct.buttonTitle}
       </Link>
      </div>
     </div>
    </div>

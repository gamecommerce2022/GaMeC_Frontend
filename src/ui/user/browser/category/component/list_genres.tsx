      ...
      <div className="bg-transparent">
        ...
        <div className="relative mt-1 rounded-md shadow-sm">
          ...
          <input
            ...
            name="filter"
            id="filter"
            className="block w-full rounded-md bg-transparent text-gray-300 border-gray-300 sm:text-sm pl-8"
            placeholder="Keyword"
            onChange={async (e: React.FormEvent<HTMLInputElement>) => {
              ...
              setTimeout(() => {
                if (value === '') {
                  let urlPath = getUrlLink('q', null);
                  navigate(`/browse?${urlPath}`, { replace: true });
                } else {
                  let itemPath = `q=${value}`;
                  let urlPath = getUrlLink('q', itemPath);
                  navigate(`/browse?${urlPath}`, { replace: true });
                }
              }, 2000);
            }}

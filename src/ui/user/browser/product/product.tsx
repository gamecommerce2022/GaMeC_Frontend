...
export const ProductPage = () => {
  ...
  useEffect(() => {
    if (productId !== undefined) {
      getCurrentUser(navigate).then((user) => {setAuthor(user)
  ...
  return <div>{loading ? null : product ? <div>
  ...
  <div className='lg:ml-80 lg:mr-[40rem] md:mx-20 sm:mx-20 mb-20'>
    ...
    <PaperAirplaneIcon
          ...
          onClick={async () => {           
            ...
            await ProductService.addComment(productId!,author._id,author.displayName,comment ?? '', navigate)            
          }}
        />
    </div>

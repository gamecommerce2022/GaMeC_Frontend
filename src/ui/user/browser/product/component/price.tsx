...
export const Discounted = ({ discount, priceOffical, priceDefault}: IPriceProps) => (
  <>
    <span
      className={`px-1 py-0.5 mr-2 bg-green-700 text-white rounded-sm`}
    >
...
export const Price = ({ priceDefault, discount, priceOffical, classes }: IPriceProps) => {
  const CreatePrice = () => { 
      ...
      if (discount) return <Discounted discount={discount} priceDefault={priceDefault} priceOffical={priceOffical} />;

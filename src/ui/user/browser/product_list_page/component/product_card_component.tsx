...
export const ProductCardComponent: React.FC<ProductCardEntity> = (
  props: ProductCardEntity
) => {
  return (
    <div
      className={classNames(
        "flex flex-col space-y-2.5 pb-2 bg-black rounded-lg border-t-0 border-x-2 border-b-2 border-gray-600"
      )}
    >
      <img
      ...
      <Link
        className="h-16 mx-1.5 flex justify-center items-center bg-blue-500 rounded-lg text-white font-bold text-xs group"

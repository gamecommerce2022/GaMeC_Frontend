...
const ProductInfoPage = () => {
 ...
 return (
  <div className="mx-auto max-w-screen-2xl py-12 px-12 bg-black">
   ...
   <h1 className="text-2xl font-medium text-white">Product Name</h1>
   ...
   <h1 className="mt-8 text-sm font-medium text-white" >Product Short Introduction Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</h1>
   <div className="flex flex-row px-12 mt-8">
    <div className="w-1/2 h-40 bg-light-green-200 mr-4">
     <h1 className="text-xl font-medium text-white">Product Type</h1>
    </div>

    <div className="w-1/2 h-40 bg-light-green-200 ml-4">
     <h1 className="text-xl font-medium text-white">Product Genes</h1>
    </div>

export const getUrlMapLink: (path: string) => string[] = function (
  path: string
): string[] {
...
export const getUrlLink: (tag: string, path: string | null) => string =
  function (tag: string, path: string | null): string {
    let paths: string[] = [];
